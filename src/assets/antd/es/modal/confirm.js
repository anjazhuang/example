...
var ConfirmDialog = function ConfirmDialog(props) {
    var onCancel = props.onCancel,
        ...
        maxable = props.maxable,
        minable = props.minable,
    ...
    return React.createElement(
        _Modal2['default'],
        { className: classString, onCancel: close.bind(undefined, { triggerCancel: true }), visible: visible, title: '', transitionName: 'zoom', footer: '', maskTransitionName: 'fade', maskClosable: maskClosable, style: style, width: width, zIndex: zIndex, afterClose: afterClose, keyboard: keyboard, maxable: maxable, minable: minable, draggable: draggable },
        React.createElement(
            'div',

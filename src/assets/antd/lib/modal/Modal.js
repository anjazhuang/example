...
var Modal = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Modal, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                _rcDialog2['default'],
                (0, _extends3['default'])({}, this.props, { footer: footer === undefined ? defaultFooter : footer, visible: visible, mousePosition: mousePosition, onClose: this.handleCancel }));
        }
    }]);
    return Modal;
}(React.Component);
...
Modal.propTypes = {
    ...
    maxable: _propTypes2['default'].bool,
    minable: _propTypes2['default'].bool,
    draggable: _propTypes2['default'].bool
    // initPosition: _propTypes2['default'].object
};

    ...
    function Dialog() {
        ...
        _this.getMaskElement = function () {
            ...
            if (props.mask) {
                ...
                maskElement = React.createElement(_LazyRenderBox2['default'], (0, _extends3['default'])({ style: _this.getMaskStyle(), key: "mask", className: props.prefixCls + '-mask', hiddenClassName: props.prefixCls + '-mask-hidden', visible: props.visible, onMouseMove: props.draggable === false ? null : this.onMouseMove, onMouseUp: props.draggable === false ? null : this.onMouseUp }, props.maskProps));
                if (maskTransition) {
